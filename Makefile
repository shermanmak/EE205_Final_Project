OBJS = main.o Game.o SplashState.o AssetManager.o InputManager.o StateMachine.o MainMenuState.o IntroState.o GameState.o Nick.o NickBattle.o Map.o Collision.o BattleState1.o Boss1.o Boss1Battle.o NPC1.o Item1.o Chad.o IntroChad.o
CXX = g++
CXXFLAGS = -std=c++11
...
NickBattle.o: NickBattle.hpp DEFINITIONS.hpp Game.hpp

Boss1.o: Boss1.hpp DEFINITIONS.hpp Game.hpp

Boss1Battle.o: Boss1Battle.hpp DEFINITIONS.hpp Game.hpp
